...
namespace OM3D
{
    ...
    namespace profile
    {
        ...
        u32 begin_profile_zone(const char *name)
        {
            ...
            // Either you forgot to call process_profile_markers every frame, or
            // you have too many marker In the later case, you can just remove
            // this assert
    ...
    {
        DEBUG_ASSERT(_state == State::Resolved || _state == State::Ended
                     || _state == State::None);
